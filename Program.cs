...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        {
            return shows.OrderBy(s => s.Name).OrderBy(s => s.EndYear).FirstOrDefault(s => s.EndYear >= 2000);
        }
        ...
        {
            return shows.FirstOrDefault(s => s.Name.Length == shows.Max(s => s.Name.Length));
        }
